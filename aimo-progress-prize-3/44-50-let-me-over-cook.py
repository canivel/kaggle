...
class AIMO3Solver:
    ...
    def _select_answer(self, detailed_results: list) -> int:
        ...
        Weights each attempt by: (1/entropy) * execution_multiplier

        Code verified (ran, no errors): 10x   -- strong evidence of correctness
        Code with errors:                0.1x  -- code bugs suggest wrong approach
